...
export function downloadPhenotypesTemplate(filename = "phenotypes-template.xlsx") {
  ...
  const P_GUIDE: [string, string, string][] = [
    ["ID матки/колонії", "Ваш ідентифікатор", "UA-QUEEN-2025-001"],
    ["Дата", "YYYY-MM-DD", "2025-08-29"],
    ["Довжина, мм", "Число (мм)", "18.2"],
    ["Маса до обльоту, мг", "Число (мг)", "210"],
    ["Маса після обльоту, мг", "Число (мг)", "245"],
    ["Колір", "Один із: світлий/жовтий/темний/чорний або текст", "жовтий"],
    ["Форма черевця", "Шкала 1–5", "4"],
    ["Симетрія ОК", "так/ні", "так"],
    ["Коментар симетрії", "Текст (за потреби)", "н/д"],
    ["Агресивність", "Шкала 1–5 (більше = агресивніша)", "2"],
    ["Схильність до роїння", "Шкала 1–5 (більше = більше роїння)", "1"],
    ["Гігієнічна поведінка, %", "0–100", "92"],
    ["Зимостійкість", "Шкала 1–5", "4"],
    ["Яйценосність, яєць/добу", "Число", "1500"],
    ["Щільність засіву", "Шкала 1–5", "5"],
    ["Медопродуктивність, кг", "Число (кг)", "28.5"],
    ["Корм взимку, кг", "Число (кг)", "8.0"],
    ["Весняний розвиток", "Шкала 1–5", "4"],
    ["Примітка", "Вільний текст", "гарна матка, легка в роботі"],
  ];
  const guideAoA: (string | number)[][] = [["Поле", "Правило", "Приклад"], ...P_GUIDE];
